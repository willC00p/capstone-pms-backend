...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('user_details', function (Blueprint $table) {
            ...
            $table->string('municipality')->required();
            $table->string('provice')->required();
            $table->string('country')->required();
            $table->string('zip_code')->required();
            $table->string('fb_account_name')->nullable();
            $table->string('father_firstname')->required();
            $table->string('father_middleinitial')->nullable();
            $table->string('father_lastname')->required();
            $table->string('mother_firstname')->required();
            $table->string('mother_middleinitial')->nullable();
            $table->string('mother_lastname')->required();
            $table->string('spouse_firstname')->required();
            $table->string('spouse_middleinitial')->nullable();
            $table->string('spouse_lastname')->required();
